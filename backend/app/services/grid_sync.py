...
def sync_area_grid_from_geometry(area, *, default_width: float, default_height: float) -> None:
    """Đồng bộ grid_range + grid_row/grid_col của area theo position/size hiện tại."""
