...
- **Nhãn port (L1):** nhãn **nằm giữa đường link**, khoảng cách **anchor → tâm nhãn** theo `port_label_offset` **trừ đi 1 ký tự (≈ độ rộng “/”)** để nhãn **đè nhẹ lên device**, **không dịch để tránh va chạm**; nhãn có thể đè lên đường link nhưng **không được chồng lên vùng chữ device** (tự đẩy ra ngoài khi giao nhau). Mức “đè” tối đa tương đương **1 ký tự “/”**.
