...
- **Post-nudge validity gate (L1):** sau khi nudge, mỗi link phải được kiểm tra lại va chạm obstacle; link nào bị nudge vào vật cản phải rollback về path trước nudge để không xuyên object.
